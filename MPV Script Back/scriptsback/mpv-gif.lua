...
--dir – Sets output directory. Default is C:/Program Files/mpv/gifs.
--rez – Sets resolution of gifs. Default is 600.
--fps – Set framerate of gifs. Default 15.
require 'mp.options'
...
filters=string.format("fps=%s,scale='trunc(ih*dar/2)*2:trunc(ih/2)*2',setsar=1/1,scale=%s:-1:flags=lanczos", fps, options.rez) --change spline to lanczos depending on preference
