...
-- 
--     mpv_path options below [[mpv]] with [[C:\Programs\mpv\mpv.exe]].

local utils = require "mp.utils"

------- Script Options -------
mpv_path = [[G:\Users\mmuel\Downloads\mpv-x86_64-20210829-git-dffb94f\mpv.exe]]
ffmpeg_path = [[G:\Users\mmuel\Downloads\mpv-x86_64-20210829-git-dffb94f\ffmpeg\bin\ffmpeg.exe]]
...
function cut_audio_fragment()
    working_dir = mp.get_property("c:/mpv")
...
mp.add_key_binding("z", "set-start-timestamp", set_start_timestamp)
mp.add_key_binding("x", "set-end-timestamp", set_end_timestamp)
